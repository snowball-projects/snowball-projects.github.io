...
- List every article's accountable editorial authors in `authors`; the same field supports one or multiple contributors, and the AI-agent writing credit renders automatically.
